...
static void hal_spi_init () {
    //SPI.begin();//Uspizig Original und WEMOS D1
	//SPI.begin(lmic_pins.sck, lmic_pins.miso, lmic_pins.mosi, 0x00); //sck, miso, mosi, cs
	//SPI.begin(18, 19, 23, 27);//esp32 Pico
	//SPI.begin(14, 2, 15, 26);//Geraet1 & geraet2
	//SPI.begin(14, 12, 13, 0);//ESP32 CAM Modul war 27
	//SPI.begin(23, 22, 19, 33);//M5Matrix Lora Modul
	//SPI.begin(18, 19, 5, 26);//Geraet3
	//SPI.begin(18, 19, 23, 16);//Cube #1
	//SPI.begin(18, 19, 23, 26);//Geraet5
	//SPI.begin(18, 19, 23, 26);//Geraet6
	//SPI.begin(18, 32, 17, 13);//Geraet6
	//SPI.begin(05, 23, 19, 16);//Geraet7
	//SPI.begin(18, 32, 17, 19);//Geraet8
	//SPI.begin(18, 19, 23, 5);//Geraet9
	SPI.begin(5, 19, 27, 18);//Geraet10 == TTGO LORA32 T3 V1.6
	
	//ESP8266
	//SPI.pin(14, 12, 13, 16); //Wemos D1 Mini V1 geht net nimm orginal SPI.begin
	//SPI.begin();//Neu für WEMOS D1
}
