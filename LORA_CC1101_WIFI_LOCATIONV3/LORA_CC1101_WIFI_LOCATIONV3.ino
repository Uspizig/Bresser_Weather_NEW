...
//#include "credentials.h"  /// PLACE YOUR WIFI credentials in this file
//#include "lorapindef_and_features.h"  /// PLACE YOUR LORA TTN credentials in this file
...
// Geraet7 is without Display! Desktoplamp  https://hackaday.io/project/180792-loralamp-airquality
// Geraet6 is without Display! TTGO V2 Mini ESP32 mit LORA SHIELD  https://www.banggood.com/de/LILYGO-TTGO-MINI-32-V2_0-ESP32-WiFi-bluetooth-Module-Development-Board-p-1286046.html */
...
// Geraet2 with BME280 //https://de.aliexpress.com/item/4000804336457.html mit LORA SHIELD von USPIZIG -https://github.com/Uspizig/LoraHubTTGOT5
// Geraet1 with BMP280 //https://de.aliexpress.com/item/4000804336457.html mit LORA SHIELD von USPIZIG -https://github.com/Uspizig/LoraHubTTGOT5
...
//if you are using a ESP8266
  //SPI.pin(18, 32, 17, 19); (lmic_pins.sck, lmic_pins.miso, lmic_pins.mosi, lmic_pins.nss)
  //SPI.begin();
/*
...
//#define geraet5 //TTGO MINI V2 -->TTN Stack V2
//#define geraet6 //TTGO MINI V2  -> TTN Stack V3
//#define geraet7 //Schreibtischlampe  -> TTN Stack V3
//#define geraet8 //ESP32 Base Board mit CC1101 Bresser  -> TTN Stack V3
       ...
       if(verbunden_indicator == LORA_TX_INIT && count_decoded_wind_messages < 3){  
        if (!receivedFlag) {
          ...
          if (count_decoded_wind_messages >= 3 && setup_lora_sucesful_flag == 0){
            ...
            Serial.println("Genug CC1101 Nachrichten empfangen Starte LoRa Sender");
            setup_lora(); 
          }
